//! SMB-specific copy pipeline functions.
...
#[cfg(feature = "smb")]
pub(crate) async fn run_smb_source_copy_pipeline<T>(
    control_file: PathBuf,
    meta_dir: PathBuf,
...
// Cross-transport functions (nfs_to_smb, smb_to_nfs) remain in
// backup/aio/directions/copy_pipelines.rs since they depend on both
// NFS and SMB modules.
